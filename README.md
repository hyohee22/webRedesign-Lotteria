...
### 3.1.2. 헤더 + 사이드 메뉴 (김채연)
1. 헤더에도 롯데리아의 브랜드 컬러인 노란색과 빨간색으로 강조를 할 수 있도록 하였다.
...
4. 마지막 섹션은 브랜드 가치를 flex 기능을 활용해 정리하여  제작하였습니다.
...
3. 각 메뉴 카드에 마수으 호버시 ↑ 방향으로 가격과 돋보기 아이콘이 등장한다.
